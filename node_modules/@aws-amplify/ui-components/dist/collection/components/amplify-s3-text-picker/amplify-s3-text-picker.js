...
export class AmplifyS3TextPicker {
    ...
    render() {
        return (h(Host, null,
            h("amplify-s3-text", { textKey: this.src, path: this.path, level: this.level, track: this.track, identityId: this.identityId, contentType: this.contentType, fallbackText: this.fallbackText }),
    ...
    static get properties() { return {
        ...
        "fallbackText": {
            ...
            "reflect": false,
            "defaultValue": "I18n.get(Translations.PICKER_TEXT)"
        }
    }; }

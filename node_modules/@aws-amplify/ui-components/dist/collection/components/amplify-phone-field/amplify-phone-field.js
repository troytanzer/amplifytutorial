...
export class AmplifyPhoneField {
    ...
    render() {
        return (h("div", null,
            h("amplify-form-field", { label: this.label, type: "tel", hint: this.hint, required: this.required },
                h("div", { class: "phone-field", slot: "input" },
                    ...
                    h("amplify-input", { fieldId: this.fieldId, handleInputChange: this.handleInputChange, placeholder: this.placeholder, name: this.fieldId, value: this.value, inputProps: this.inputProps, disabled: this.disabled })))));
    }
    ...
    static get properties() { return {
        ...
        "label": {
            ...
            "attribute": "label",
            "reflect": false,
            "defaultValue": "I18n.get(Translations.PHONE_LABEL)"
        },
        "placeholder": {
            "type": "string",
            "mutable": false,
            ...
            "reflect": false,
            "defaultValue": "I18n.get(Translations.PHONE_PLACEHOLDER)"
        },
        "hint": {
            "type": "string",
            "mutable": false,

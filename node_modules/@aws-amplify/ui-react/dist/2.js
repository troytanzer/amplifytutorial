...
function () {
  function class_1(hostRef) {
    ...
    this.pickerText = _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_06ef20e7_js__WEBPACK_IMPORTED_MODULE_3__["T"].PICKER_TEXT);
    this.albumItems = [];
    this.imgArr = {};
          ...
          switch (_c.label) {
            case 0:
              ...
              if (!_aws_amplify_storage__WEBPACK_IMPORTED_MODULE_5__["Storage"] || typeof _aws_amplify_storage__WEBPACK_IMPORTED_MODULE_5__["Storage"].list !== 'function') {
                throw new Error(_constants_6835ae6a_js__WEBPACK_IMPORTED_MODULE_4__["d"]);
              }
            ...
            case 1:
              ...
              return [4
              /*yield*/
              , _aws_amplify_storage__WEBPACK_IMPORTED_MODULE_5__["Storage"].list(path, {
                level: level,
                track: track,
    ...
    this.marshal = function (list) {
      list.forEach(function (item) {
        ...
        if (_storage_helper_21c6d15f_js__WEBPACK_IMPORTED_MODULE_6__["i"].has(ext)) {

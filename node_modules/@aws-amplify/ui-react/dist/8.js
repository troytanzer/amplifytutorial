...
/* harmony import */ var _Translations_06ef20e7_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Translations-06ef20e7.js */ "../amplify-ui-components/dist/esm-es5/Translations-06ef20e7.js");
...
function () {
  function AmplifyCodeField(hostRef) {
    ...
    this.fieldId = _constants_6835ae6a_js__WEBPACK_IMPORTED_MODULE_3__["j"];
    /** Used for the code label */

    this.label = _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_06ef20e7_js__WEBPACK_IMPORTED_MODULE_2__["T"].CODE_LABEL);
    /** Used for the placeholder label */

    this.placeholder = _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_06ef20e7_js__WEBPACK_IMPORTED_MODULE_2__["T"].CODE_PLACEHOLDER);
...
function () {
  function AmplifyCountryDialCode(hostRef) {
    ...
    this.fieldId = _constants_6835ae6a_js__WEBPACK_IMPORTED_MODULE_3__["C"];
...
function () {
  function AmplifyEmailField(hostRef) {
    ...
    this.fieldId = _constants_6835ae6a_js__WEBPACK_IMPORTED_MODULE_3__["E"];
    /** Used for the EMAIL label */

    this.label = _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_06ef20e7_js__WEBPACK_IMPORTED_MODULE_2__["T"].EMAIL_LABEL);
    /** Used for the placeholder label */

    this.placeholder = _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_06ef20e7_js__WEBPACK_IMPORTED_MODULE_2__["T"].EMAIL_PLACEHOLDER);
    /** The required flag in order to make an input required prior to submitting a form */
...
function () {
  function AmplifyPasswordField(hostRef) {
    ...
    this.fieldId = _constants_6835ae6a_js__WEBPACK_IMPORTED_MODULE_3__["k"];
    /** Used for the password label */

    this.label = _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_06ef20e7_js__WEBPACK_IMPORTED_MODULE_2__["T"].PASSWORD_LABEL);
    /** Used for the placeholder label */

    this.placeholder = _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_06ef20e7_js__WEBPACK_IMPORTED_MODULE_2__["T"].PASSWORD_PLACEHOLDER);
    /** The required flag in order to make an input required prior to submitting a form */
...
function () {
  function AmplifyPhoneField(hostRef) {
    ...
    this.fieldId = _constants_6835ae6a_js__WEBPACK_IMPORTED_MODULE_3__["b"];
    /** Used for the Phone label */

    this.label = _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_06ef20e7_js__WEBPACK_IMPORTED_MODULE_2__["T"].PHONE_LABEL);
    /** Used for the placeholder label */

    this.placeholder = _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_06ef20e7_js__WEBPACK_IMPORTED_MODULE_2__["T"].PHONE_PLACEHOLDER);
    /** The required flag in order to make an input required prior to submitting a form */
...
function () {
  function AmplifyUsernameField(hostRef) {
    ...
    this.fieldId = _constants_6835ae6a_js__WEBPACK_IMPORTED_MODULE_3__["l"];
    /** Used for the username label */

    this.label = _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_06ef20e7_js__WEBPACK_IMPORTED_MODULE_2__["T"].USERNAME_LABEL);
    /** Used for the placeholder label */

    this.placeholder = _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_06ef20e7_js__WEBPACK_IMPORTED_MODULE_2__["T"].USERNAME_PLACEHOLDER);
    /** The required flag in order to make an input required prior to submitting a form */
